...
## 📦 Local Setup
1. Clone the repository: `git clone https://github.com/sainishanth2006/Medi-Minds.git`
2. Install dependencies: `npm install`
3. Create a `.env` file and add your `VITE_GEMINI_API_KEY` and Firebase credentials.
